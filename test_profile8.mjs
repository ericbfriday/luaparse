...
function convertPositionFast(node, result) {
  ...
  if (range === undefined) {
    ...
    result.position = {
      start: { line: loc.start.line, column: loc.start.column + 1, offset: range[0] },
      end: { line: loc.end.line, column: loc.end.column + 1, offset: range[1] }
    };
  }
}
...
function convertNodeFast(node) {
  ...
  convertPositionFast(node, result);
